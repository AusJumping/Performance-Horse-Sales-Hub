  ...
  <div class="body">
    ...
    <div class="section">
      ...
      <ol class="clause-list">
        ...
        <li data-n="2"><strong>Commission / Completion Fee.</strong> The Seller agrees to pay PHS a commission/completion fee of ${escapeHtml(commissionDisplay)} of the listing price (inclusive of GST where applicable)${data.minimumFee || data.maximumFee ? `, subject to a minimum fee of ${data.minimumFee ?? "—"}${data.maximumFee ? ` and a maximum fee of ${data.maximumFee}` : ""}` : ""}. The fee is due — whichever occurs first — when: (a) a deposit is paid or vetting is booked; (b) the horse is leased or sent on trial; (c) the horse is sold by any means or channel, regardless of the channel, method or means which initiated the sale; or (d) three months have passed since listing commencement (see pro rata clause below). The commission is payable within 24 hours of the invoice being issued. All fees are plus GST.</li>
        ...
        <li data-n="11"><strong>Limitation of Liability.</strong> PHS acts as a facilitating agent only and accepts no liability for the accuracy of seller-provided information, the fitness of the horse for any purpose, or any disputes arising between buyer and seller.</li>
