  ...
  <div class="body">
    ...
    <div class="section">
      ...
      <ol class="clause-list">
        ...
        <li data-n="2"><strong>Commission.</strong> Upon successful sale of the horse, the Seller agrees to pay PHS a commission equal to ${escapeHtml(commissionDisplay)} of the final agreed sale price (inclusive of GST where applicable)${data.minimumFee || data.maximumFee ? `, subject to a minimum fee of ${data.minimumFee ?? "—"}${data.maximumFee ? ` and a maximum fee of ${data.maximumFee}` : ""}` : ""}. Commission is payable within 24 hours of the deposit being paid and the sale being booked.</li>
        ...
        <li data-n="6"><strong>Price Changes.</strong> The Seller must notify PHS in writing of any change to the asking price or material change to the horse's condition.</li>
        <li data-n="7"><strong>Cancellation.</strong> Either party may terminate this agreement by providing 14 days' written notice. If the horse is sold during the listing period — or within 60 days after termination to a buyer introduced by PHS — the commission remains payable.</li>
        <li data-n="8"><strong>Limitation of Liability.</strong> PHS acts as a facilitating agent only and accepts no liability for the accuracy of seller-provided information, the fitness of the horse for any purpose, or any disputes arising between buyer and seller.</li>
        <li data-n="9"><strong>Governing Law.</strong> This agreement is governed by the laws of Australia. Any disputes shall be resolved in the jurisdiction of the state in which the Seller resides.</li>
      </ol>
    </div>
